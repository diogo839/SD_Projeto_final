...
//                try {
//
////                    while (tempoThread != 0 && !exitTrhead) {
////
////                        try {
////
////                            Thread.sleep(1000L);// 1000L = 1000ms = 1 second
...
////                            tempoThread--;
////
////                            if (tempoThread == 5 && estado.equals("pausa")) {
////                                sendMensagens(0, vezJogador);
////                            } else if (tempoThread == 10 && estado.equals("jogar")) {
////                                sendMensagens(4, vezJogador);
////                            } else if (tempoThread == 5 && estado.equals("jogar")) {
////                                sendMensagens(5, vezJogador);
////                            }
////
////                            //
////                            if (estado.equals("pausa")) {
...
//
//
//                    //Verifica se a trhad é para o incio do jogo ou se é para fazer stand pelo jogador depois de 20segundos
//                    if (estado.equals("pausa")) {
//
//                        if (listaLogin.size() > 3) {
//                            numJogadoresTable = 3;
